...
param_grid = {
    "reg_alpha": [0, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000],
    "reg_lambda": [0, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000],
}
...
joblib.dump(grid_search, "Step4_GridSearchCV_AmesHousing_reg_params.pkl")
