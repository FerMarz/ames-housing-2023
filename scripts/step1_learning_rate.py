...
param_grid = {
    "learning_rate": np.linspace(0.005, 0.5, 12),
}

# Define el número de hilos para XGBoost y GridSearchCV
xgb_threads = 12
grid_search_threads = 2

# Crear el modelo XGBoost
xgb_model = default_xgb(n_jobs=xgb_threads, n_estimators=3000)
...
joblib.dump(grid_search, "Step1_GridSearchCV_AmesHousing_learning_rate.pkl")
